        ...
        <div className="max-w-6xl mx-auto px-12">
          <div className="grid lg:grid-cols-5 gap-12 items-start">
            ...
            <div className="lg:col-span-2">
              <h2 className="text-2xl font-bold text-[#003E3B] uppercase mb-6">
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                ...
                <div className="pt-4">
                  ...
                  <div className="flex space-x-4">
                    {/* Facebook */}
                    <div className="w-12 h-12 border-2 border-green-200 rounded-full bg-white flex items-center justify-center hover:border-green-400 transition-colors cursor-pointer">
